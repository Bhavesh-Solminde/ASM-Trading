 ...
 * icon rail (desktop) or bottom navigation bar (phone).
 */
export function PlatformShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="grid h-dvh min-h-[640px] grid-cols-[76px_minmax(0,1fr)] grid-rows-[60px_32px_minmax(0,1fr)] phone:min-h-0 phone:grid-cols-[minmax(0,1fr)] phone:grid-rows-[56px_28px_minmax(0,1fr)_var(--phone-nav-h,64px)] [@media(height<30rem)]:grid-rows-[48px_0px_minmax(0,1fr)]">
      <TopBar />
      <Ticker />
      <IconRail />
